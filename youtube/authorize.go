...
//      Console and set the RedirectURL property on the static object to one
//      of those redirect URIs. For example:
//      static.RedirectURL = "http://localhost:8090"
...
//      static.RedirectURL = "urn:ietf:wg:oauth:2.0:oob"
...
func getClient(scope string) *http.Client {
	...
	b, err := ioutil.ReadFile(config.GetString("youtube.key_path"))
	if err != nil {
	...
	if err != nil {
		log.Fatalf("Unable to parse client secret file to static: %v", err)
	}
